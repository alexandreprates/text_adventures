...
`original-dungeon-tileset.png` is an original AI-generated concept tileset created for Text Adventures.

It is intended as the first visual direction for the future canvas dungeon renderer. The sheet follows a fantasy dungeon crawler vocabulary with floor, wall, fog, player, enemy, loot, door, stairs, trap, equipment, altar, and portal tiles.
...
- Add tests that assert every known dungeon symbol maps to a valid tile.
- Keep ASCII map fallback rendering available during the transition.
