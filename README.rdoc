...
Explore the ruins, confront incredible creatures and increase the power of your character. All directly from your browser.
...
equipment, spells, dungeon movement, random encounters, combat, loot, and basic
game-over handling.
...
Game content is stored in YAML files under `data/`:
  ...
  data/creatures.yml # creatures, attacks, loot, and status effects
