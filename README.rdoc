...
The current implementation is an early Ruby library foundation. It includes the
`Extent` bounded-number helper and its specs. The browser game, server command,
town, shops, dungeon, combat, inventory, spells, and persistence described below
are planned gameplay behavior and are not fully implemented yet.
