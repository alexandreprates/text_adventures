...
RSpec.describe "Project dependency setup" do
  ...
  it "defines separate Docker targets for the web proxy and game server" do
    ...
    expect(compose).to include("./frontend/nginx.conf:/etc/nginx/conf.d/default.conf:ro")
    expect(compose).not_to include("./frontend/public:/usr/share/nginx/html:ro")
    ...
    expect(orange_compose).to include("./frontend/nginx.conf:/etc/nginx/conf.d/default.conf:ro")
    expect(orange_compose).not_to include("./frontend/public:/usr/share/nginx/html:ro")
