...
RSpec.describe "Frontend assets" do
  ...
  it "wires the frontend to the JSON API endpoints" do
    ...
    expect(html).to include('id="combat-cue"')
    ...
    expect(javascript).to include('PLAYER -> ENEMY')
    expect(javascript).to include('ENEMY -> PLAYER')
    ...
    expect(styles).to include('.combat-cue')
    expect(styles).to include('.combat-source')
    expect(styles).to include('.combat-target')
