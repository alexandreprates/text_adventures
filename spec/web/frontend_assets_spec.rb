...
RSpec.describe "Frontend assets" do
  ...
  it "wires the frontend to the JSON API endpoints" do
    ...
    expect(javascript).to include('function safeAutoExploreDirections(state)')
    ...
    expect(javascript).to include('if (isLevelTransitionPosition(state, candidate.position)) return false')
